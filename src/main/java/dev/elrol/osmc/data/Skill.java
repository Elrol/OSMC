...
import dev.elrol.osmc.data.exp.abstractexps.ExpSource;import net.minecraft.text.Text;import net.minecraft.text.TextCodecs;import net.minecraft.util.Formatting;import net.minecraft.util.Identifier;
...
public class Skill {
    ...
    ).apply(instance, (id, displayName, levelFormula, expSources, globalChanceDrops) -> {
