...
public abstract class AbilityEffect {
    ...
    public static <T extends AbilityEffect> Products.P4<RecordCodecBuilder.Mu<T>, Identifier, Integer, Text, Text> getCommonCodec(RecordCodecBuilder.Instance<T> instance) {
