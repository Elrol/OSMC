...
public class EntityInteractionExpSource extends ExpSource {
    ...
    public static final MapCodec<EntityInteractionExpSource> CODEC = RecordCodecBuilder.mapCodec(instance -> ExpSource.getCommonCodec(instance)
            .and(OSMCConstants.TARGET_ENTITY_TYPE_CODEC.listOf().fieldOf("entities").forGetter(EntityInteractionExpSource::getEntities)
    ...
    public ExpSourceType<?> getType() {
        return OSMCExpSourceTypeRegistry.ENTITY_INTERACT_EXP_SOURCE;
    }
    ...
    public List<SkillTrigger> getTriggers() {
        return List.of(SkillTrigger.ENTITY_INTERACT);
    }
}
